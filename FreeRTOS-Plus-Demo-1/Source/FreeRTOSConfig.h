...
#define configLCD_TASK_PRIORITY						( 0U )
/* Stack sizes to assign to tasks created by this demo. */
#define configUART_COMMAND_CONSOLE_STACK_SIZE		( configMINIMAL_STACK_SIZE * 20 )
#define configI2C_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 4 )
#define configLCD_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 4 )

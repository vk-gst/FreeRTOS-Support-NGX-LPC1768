...
Source/%.o: ../Source/%.c
	...
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -I"/root/Documents/test31jan/FINALPROJECT/FreeRTOS-Plus-Demo-1/Source" -I"/root/Documents/test31jan/FINALPROJECT/FreeRTOS-Products/FreeRTOS/include" -I"/root/Documents/test31jan/FINALPROJECT/FreeRTOS-Products/FreeRTOS/portable/GCC/ARM_CM3" -I"/root/Documents/test31jan/FINALPROJECT/lpc17xx.cmsis.driver.library/Include" -I"/root/Documents/test31jan/FINALPROJECT/CMSISv2p00_LPC17xx/inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
